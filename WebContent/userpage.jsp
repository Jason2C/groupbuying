...
content=" 拉手网广州站-超人气团购网站。拉手网为您提供广州的生活团购,商品团购,酒店团购,化妆品团购等产品,为您精选广州的餐厅、酒吧、KTV、SPA、美发店、摄影、瑜伽馆等特色商家，让您体验超人气团购网站给您带来的超低折扣!">
...
<LINK rel=stylesheet type=text/css href="regist_files/base80.css"><LINK 
rel=stylesheet type=text/css href="regist_files/myls29.css">
<SCRIPT type=text/javascript src="regist_files/jquery-1.3.2.min.js"></SCRIPT>

<SCRIPT type=text/javascript 
src="regist_files/jquery.autocomplete-02-min.js"></SCRIPT>
...
<UL>
  <LI id=tb_1 class=state_login onclick=x:HoverLi(1);><A 
  href="http://www.lashou.com/regn.php#">个人用户</A> </LI>
  <LI id=tb_2 class=out_login onclick=x:HoverLi(2);><A 
  href="http://www.lashou.com/regn.php#">校园用户</A> </LI></UL></DIV>
<FORM id=reg method=post action=regn2.php>
...
align=center>
  ...
  <TR>
    ...
    <TD width="75%"><INPUT id=email class=kuangaa_login maxLength=200 size=28 
      name=email> </TD></TR>
  <TR>
    <TD style="FONT-SIZE: 14px" height=40 align=right>用户名：</TD>
    <TD><INPUT id=user_id class=kuangaa_login maxLength=20 size=28 
      name=user_id></TD></TR>
  <TR>
    <TD style="FONT-SIZE: 14px" height=40 align=right>密码：</TD>
    <TD><INPUT id=pwd class=kuangaa_login onkeyup=pwStrength(this.value) 
      onpaste="return false;" maxLength=99 size=28 type=password name=pwd></TD></TR>
  <TR>
    <TD></TD>
    <TD class=grade-pwd>
      <UL>
  ...
  <TR>
    ...
    <TD><INPUT id=pwd2 class=kuangaa_login onpaste="return false;" 
      maxLength=99 size=28 type=password name=pwd2></TD></TR>
  <TR>
    <TD style="FONT-SIZE: 14px" height=40 align=right>所在城市：</TD>
    <TD><SELECT id=cityid name=cityid> <OPTGROUP 
  ...
  <TR>
    ...
    <TD><INPUT style="WIDTH: 60px" class=kuangaa_login maxLength=4 size=4 
      name=yan> <IMG style="VERTICAL-ALIGN: middle" id=chkimg name=chkimg 
      align=absMiddle src="regist_files/code.png" width=65 height=20> <SPAN 
      style="CURSOR: pointer" onclick=cimg()><SPAN 
...
<DL class=login-side-reg>
  <DT>已有拉手账户？ 
  <DD>请直接 <A class=reg_login href="http://www.lashou.com/login.php">登 录</A> 
</DD></DL></DIV>
